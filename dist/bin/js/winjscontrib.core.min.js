...
},rendered:function(){},ready:function(){}};n._corePages={get:a.get,render:a.render,define:a.define,_remove:a._remove,_viewMap:k};var W={define:T,get:P,render:S,_remove:C,_viewMap:k},J=WinJS.UI.Pages;WinJS.Namespace._moduleDefine(n,null,W),J.get=W.get,J.define=W.define,J.render=W.render,J._remove=W._remove,WinJS.UI.HtmlControl=WinJS.Class.define(function(e,n,t){WinJS.UI.Pages.render(n.uri,e,n).then(t,function(){t()})})}}(e.UI.Pages,__global,WinJS,WinJS.UI.Pages,WinJS.Utilities,WinJS.Utilities,profiler,WinJS.Promise,WinJS.UI.Fragments,WinJS.UI)}(t=n.Pages||(n.Pages={}))}(n=e.UI||(e.UI={}))}(WinJSContrib||(WinJSContrib={}));