...
{
    "tv/scrollViewerPageDown": "Bas de page",
    "tv/scrollViewerPageUp": "Haut de page",
    "ui/appBarAriaLabel": "Barre des applications",
    "ui/appBarCommandAriaLabel": "Élément de la barre des applications",
    "ui/appBarOverflowButtonAriaLabel": "Afficher plus",
    "ui/autoSuggestBoxAriaLabel": "Zone de suggestion automatique",
    "ui/autoSuggestBoxAriaLabelInputNoPlaceHolder": "Zone de suggestion automatique, Entrée pour soumettre la requête, Échap pour effacer le texte",
    "ui/autoSuggestBoxAriaLabelInputPlaceHolder": "Zone de suggestion automatique, {0}, Entrée pour soumettre la requête, Échap pour effacer le texte",
    "ui/autoSuggestBoxAriaLabelQuery": "Suggestion : {0}",
    "ui/autoSuggestBoxAriaLabelSeparator": "Séparateur : {0}",
    "ui/autoSuggestBoxAriaLabelResult": "Résultat : {0}, {1}",
    "ui/averageRating": "Classement moyen",
    "ui/backbuttonarialabel": "Précédent",
    "ui/chapterSkipBackMediaCommandDisplayText": "Chapitre précédent",
    "ui/chapterSkipForwardMediaCommandDisplayText": "Chapitre suivant",
    "ui/clearYourRating": "Effacer votre évaluation",
    "ui/closedCaptionsLabelNone": "Désactivé",
    "ui/closedCaptionsMediaCommandDisplayText": "Sous-titrage",
    "ui/closeOverlay": "Fermer",
    "ui/commandingSurfaceAriaLabel": "Surface de commande",
    "ui/commandingSurfaceOverflowButtonAriaLabel": "Afficher plus",
    "ui/datePicker": "Sélecteur de date",
    "ui/fastForwardMediaCommandDisplayText": "Avance rapide",
    "ui/fastForwardFeedbackDisplayText": " {0}X",
    "ui/fastForwardFeedbackSlowMotionDisplayText": "0,5X",
    "ui/flipViewPanningContainerAriaLabel": "Conteneur de défilement",
    "ui/flyoutAriaLabel": "Menu volant",
    "ui/goToFullScreenButtonLabel": "Passer en plein écran",
    "ui/goToLiveMediaCommandDisplayText": "LIVE",
    "ui/hubViewportAriaLabel": "Conteneur de défilement",
    "ui/listViewViewportAriaLabel": "Conteneur de défilement",
    "ui/mediaErrorAborted": "La lecture a été interrompue. Réessayez.",
    "ui/mediaErrorNetwork": "Une erreur de connexion au réseau s’est produite.",
    "ui/mediaErrorDecode": "Décodage du contenu impossible",
    "ui/mediaErrorSourceNotSupported": "Ce type de contenu n’est pas pris en charge.",
    "ui/mediaErrorUnknown": "Une erreur inconnue s’est produite.",
    "ui/mediaPlayerAudioTracksButtonLabel": "Pistes audio",
    "ui/mediaPlayerCastButtonLabel": "Distribution",
    "ui/mediaPlayerChapterSkipBackButtonLabel": "Précédent",
    "ui/mediaPlayerChapterSkipForwardButtonLabel": "Suivant",
    "ui/mediaPlayerClosedCaptionsButtonLabel": "Sous-titres",
    "ui/mediaPlayerFastForwardButtonLabel": "Avance rapide",
    "ui/mediaPlayerFullscreenButtonLabel": "Plein écran",
    "ui/mediaPlayerLiveButtonLabel": "LIVE",
    "ui/mediaPlayerNextTrackButtonLabel": "Suivante",
    "ui/mediaPlayerOverlayActiveOptionIndicator": "(Activé)",
    "ui/mediaPlayerPauseButtonLabel": "Pause",
    "ui/mediaPlayerPlayButtonLabel": "Lire",
    "ui/mediaPlayerPlayFromBeginningButtonLabel": "Rediffuser",
    "ui/mediaPlayerPlayRateButtonLabel": "Vitesse de lecture",
    "ui/mediaPlayerPreviousTrackButtonLabel": "Précédente",
    "ui/mediaPlayerRewindButtonLabel": "Rembobiner",
    "ui/mediaPlayerStopButtonLabel": "Arrêter",
    "ui/mediaPlayerTimeSkipBackButtonLabel": "Rediffusion de 8 secondes",
    "ui/mediaPlayerTimeSkipForwardButtonLabel": "Saut de 30 secondes",
    "ui/mediaPlayerToggleSnapButtonLabel": "Aligner",
    "ui/mediaPlayerVolumeButtonLabel": "Volume",
    "ui/mediaPlayerZoomButtonLabel": "Zoom",
    "ui/menuCommandAriaLabel": "Élément de menu",
    "ui/menuAriaLabel": "Menu",
    "ui/navBarContainerViewportAriaLabel": "Conteneur de défilement",
    "ui/nextTrackMediaCommandDisplayText": "Piste suivante",
    "ui/off": "Désactivé",
    "ui/on": "Activé",
    "ui/pauseMediaCommandDisplayText": "Pause",
    "ui/playFromBeginningMediaCommandDisplayText": "Rejouer",
    ...
    "ui/playMediaCommandDisplayText": "Lire",
    "ui/pivotAriaLabel": "Zone dynamique",
    "ui/pivotViewportAriaLabel": "Conteneur de défilement",
    "ui/replayMediaCommandDisplayText": "Rejouer",
    "ui/rewindMediaCommandDisplayText": "Rembobiner",
    "ui/rewindFeedbackDisplayText": " {0}X",
    "ui/rewindFeedbackSlowMotionDisplayText": "0,5X",
    "ui/searchBoxAriaLabel": "Zone de recherche",
    "ui/searchBoxAriaLabelInputNoPlaceHolder": "Zone de recherche, Entrée pour soumettre la requête, Échap pour effacer le texte",
    "ui/searchBoxAriaLabelInputPlaceHolder": "Zone de recherche, {0}, Entrée pour soumettre la requête, Échap pour effacer le texte",
    "ui/searchBoxAriaLabelButton": "Cliquer pour soumettre la requête",
    "ui/seeMore": "Voir plus",
    "ui/selectAMPM": "Sélectionner A.M P.M",
    "ui/selectDay": "Sélectionner le jour",
    "ui/selectHour": "Sélectionner l’heure",
    "ui/selectMinute": "Sélectionner les minutes",
    "ui/selectMonth": "Sélectionner le mois",
    "ui/selectYear": "Sélectionner l’année",
    "ui/settingsFlyoutAriaLabel": "Paramètres du menu volant",
    "ui/stopMediaCommandDisplayText": "Arrêter",
    "ui/tentativeRating": "Classement provisoire",
    "ui/timePicker": "Sélecteur d’heure",
    "ui/timeSeparator": ":",
    "ui/timeSkipBackMediaCommandDisplayText": "Retour rapide",
    "ui/timeSkipForwardMediaCommandDisplayText": "Avance rapide",
    "ui/toolbarAriaLabel": "Barre d’outils",
    "ui/toolbarOverflowButtonAriaLabel": "Afficher plus",
    "ui/unrated": "Non classé",
    "ui/userRating": "Classement de l’utilisateur",
