(function () {
    ...
    WinJS.UI.Pages.define("./demos/navigation/childviewflyout/basics/childviewflyout.html", {
        ...
        openView: function () {
            this.childview.open("./demos/navigation/childviewflyout/basics/page1/page1.html");
        },

        openView2: function () {
            this.childview.open("./demos/navigation/childviewflyout/basics/page2/page2.html");
        }
    });
})();
