...
(function (Animation) {
    ...
    Animation.slideFromBottom = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideFromBottom', true, options);
    }
    Animation.slideFromTop = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideFromTop', true, options);
    }
    Animation.slideFromLeft = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideFromLeft', true, options);
    }
    Animation.slideFromRight = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideFromRight', true, options);
    }
    Animation.slideToBottom = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideToBottom', false, options);
    }
    Animation.slideToTop = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideToTop', false, options);
    }
    Animation.slideToLeft = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideToLeft', false, options);
    }
    Animation.slideToRight = function (elements, options) {
        return slideAnim(elements, 'MCNEXT-slideToRight', false, options);
    }
