...
(function () {
     ...
     * @returns {WinJSContrib.Task}
      */
    WinJSContrib.Tasks = function (dataArray) {
        var dataPromise = WinJS.Promise.as(dataArray);

        /** 
         * @class WinJSContrib.Task 
         * @see WinJSContrib.Tasks
         */
        var Task =

            {
                 ...
                 * @method WinJSContrib.Task#waterfall
                 ...
                 * @method WinJSContrib.Task#parallel
                 * @param {function} promiseCallback function applyed to each item (could return a promise for item callback completion)
                 * @returns {WinJS.Promise}
                 */
                 ...
                 * @method WinJSContrib.Task#batch
                 * @param {function} promiseCallback function applyed to each item (could return a promise for item callback completion)
                 * @returns {WinJS.Promise}
                 */
        ...
        */
         ...
         */
        WinJSContrib.Utils.readProtocol = function (args) {
         ...
         * @returns {boolean}
         */
        WinJSContrib.Utils.isConnected = function () {
         ...
         * @returns {boolean}
         */
        WinJSContrib.Utils.hasInternetAccess = function () {
            var nlvl = Windows.Networking.Connectivity.NetworkConnectivityLevel;
            var profile = Windows.Networking.Connectivity.NetworkInformation.getInternetConnectionProfile();
            if (profile !== null) {
                var level = profile.getNetworkConnectivityLevel();
