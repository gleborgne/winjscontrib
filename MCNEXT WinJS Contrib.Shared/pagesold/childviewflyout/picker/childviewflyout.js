(function () {
    ...
    WinJS.UI.Pages.define("./pages/childviewflyout/picker/childviewflyout.html", {
        ...
        openView: function () {
            var page = this;
            this.childview.pick("./pages/childviewflyout/picker/page1/page1.html").done(function (arg) {
                if (arg.completed) {
        ...
        openView2: function () {
            var page = this;
            this.childview.pick("./pages/childviewflyout/picker/page2/page2.html").done(function (arg) {
                if (arg.completed) {
