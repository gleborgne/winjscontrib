    ...
    WinJS.Namespace.define("MCNEXT.UI", {
        TabPages: WinJS.Class.define(
            ...
            function TabPages(element, options) {
                ...
                ctrl.navigator = new MCNEXT.UI.PageControlNavigator(ctrl.tabContent, { global: false, delay: 40 });
                ctrl.navigator.animations.exitPage = MCNEXT.UI.Animation.tabExitPage;
                ctrl.navigator.animations.enterPage = MCNEXT.UI.Animation.tabEnterPage;
                ...
                setSwipeSlideOnDefaultTab: function (rightbar) {
                    ...
                    ctrl.swipeSlide = new MCNEXT.UI.SwipeSlide(ctrl.tabContent);
                    ctrl.navigator.animations.exitPage = MCNEXT.UI.Animation.fadeOut;
                    ...
                    ctrl.swipeSlide.onswipe = function (arg) {
                        ...
                        if (ctrl.currentTab == null)
                            ...
                            ctrl.navigator.animations.enterPage = function () {
                                if (ctrl.left == 'left')
                                    MCNEXT.UI.Animation.slideFromRight(ctrl.tabContent);
                                else
                                    MCNEXT.UI.Animation.slideFromLeft(ctrl.tabContent);
                            }
                ...
                addTabs: function (tabItems, group) {
                    ...
                    if (template)
                        template = MCNEXT.Utils.getTemplate(template);
