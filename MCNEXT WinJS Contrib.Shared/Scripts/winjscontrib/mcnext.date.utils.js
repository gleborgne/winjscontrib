...
/// <reference path="mcnext.binding.utils.js" />
...
(function (MCNEXT) {
    (function (Utils, Bindings) {
        'use strict';
        MCNEXT.Utils.momentFr = function () {
            moment.locale('fr', {
        ...
        function formatDateBinding(source, sourceProperty, dest, destProperty) {
            ...
            if (!sourcedata) {
                ...
                var arg = MCNEXT.Bindings.bindingArguments(dest, 'formatDate');
        ...
        function humanizeDate(source, sourceProperty, dest, destProperty) {
            ...
            if (!sourcedata) {
                ...
                var arg = MCNEXT.Bindings.bindingArguments(dest, "humanizeFormat"),
                    addSuffix = MCNEXT.Bindings.bindingArguments(dest, "addSuffix");
    ...
    })(MCNEXT.Utils || (MCNEXT.Utils = {}), MCNEXT.Bindings || (MCNEXT.Bindings = {}));
